...
const Droppable: React.FC = () => {
    ...
    const renderComponent = (childIndex: number, name: string, parentID: string) => {
        switch (name) {
            ...
            case 'ul':
                return <UlComponent key={childIndex} childIndex={childIndex} parentID={parentID} />;
            case 'ol':
                return <OlComponent key={childIndex} childIndex={childIndex} parentID={parentID} />;
            case 'dl':
                return <DlComponent key={childIndex} childIndex={childIndex} parentID={parentID} />;
            case 'fieldset':
                return <FieldSetComponent key={childIndex} childIndex={childIndex} parentID={parentID} />;
            case 'form':
                return <FormComponent key={childIndex} childIndex={childIndex} parentID={parentID} />;
            case 'table':
