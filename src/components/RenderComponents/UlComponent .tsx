...
// const UlComponent: React.FC<UlComponentProps> = ({ childIndex, parentID, depth, maxDepth = 1 }) => {
...
//             case 'ul':
//                 return <UlComponent key={index} childIndex={index} parentID={droppableUlid} depth={depth + 1} />;
//             case 'ol':
