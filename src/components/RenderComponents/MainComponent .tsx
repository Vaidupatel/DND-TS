...
const MainComponent: React.FC<MainComponentProps> = ({ childIndex, parentID, depth, maxDepth = 1, onUpdate, onRemove }) => {
    ...
    useEffect(() => {
        ...
        const htmlString = `<main class="${droppableMainid}">\n${mergedChildrenHTML}\n</main>`;
        const cssString = `
      .${droppableMainid} {
      ...
      `;
        ...
        onUpdate(droppableMainid, htmlString, cssString);
    }, [baseStyles, childrenData, droppableMainid, onUpdate]);
