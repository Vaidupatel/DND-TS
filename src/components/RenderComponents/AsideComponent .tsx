...
const AsideComponent: React.FC<AsideComponentProps> = ({ childIndex, parentID, depth, maxDepth = 1, onUpdate, onRemove }) => {
    ...
    useEffect(() => {
        ...
        const htmlString = `<aside class="${droppableAsideid}">\n${mergedChildrenHTML}\n</aside>`;
        const cssString = `
        .${droppableAsideid} {
        ...
        onUpdate(droppableAsideid, htmlString, cssString);
    }, [baseStyles, childrenData, droppableAsideid, onUpdate]);
            ...
            case 'aside':
                return (
                    <AsideComponent
                        ...
                        depth={depth + 1}
                        maxDepth={maxDepth}
                        onUpdate={handleChildUpdate} onRemove={handleChildRemove}
                    />
                );
            case 'nav':
                return <NavComponent
