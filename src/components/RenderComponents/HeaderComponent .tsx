...
const HeaderComponent: React.FC<HeaderComponentProps> = ({ childIndex, parentID, depth, maxDepth = 1, onUpdate, onRemove }) => {
    ...
    useEffect(() => {
        ...
        const htmlString = `<header class="${droppableHeaderid}">\n${mergedChildrenHTML}\n</header>`;
        const cssString = `
      .${droppableHeaderid} {
      ...
      `;
        ...
        onUpdate(droppableHeaderid, htmlString, cssString);
    }, [baseStyles, childrenData, droppableHeaderid, onUpdate]);
