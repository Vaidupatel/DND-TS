...
const TableComponent: React.FC<TableComponentProps> = ({ childIndex, parentID, depth, maxDepth = 1 }) => {
    ...
    const renderComponent = (name: string, index: number) => {
        ...
        switch (name) {
            ...
            case 'span':
                return <SpanComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'section':
                return <SectionComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} maxDepth={maxDepth} />;
            case 'header':
                return <HeaderComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'footer':
                return <FooterComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'main':
                return <MainComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'article':
                return <ArticleComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'aside':
                return <AsideComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'nav':
                return <NavComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'ul':
                return <UlComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'ol':
                return <OlComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'dl':
                return <DlComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'fieldset':
                return <FieldSetComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'form':
                return <FormComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'table':
                return <TableComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'iframe':
                return <IFrameComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
            case 'figure':
                return <FigureComponent key={index} childIndex={index} parentID={droppableTableid} depth={depth + 1} />;
